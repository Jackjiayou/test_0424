...
def on_open(ws):
    ...
    send_dict = {
        ...
        "business": {
            ...
            "aue": "raw",
            #"text": '\uFEFF' + "[content]\n市场上类似的产品很多，贵公司的产品有什么特别之处吗"
            #"text": '\uFEFF' + "[content]\n标准的语音，用于介绍双迪公司还有他的企业文化"
            "text": '\uFEFF' + "[content]\n我们的商品是核苷酸，公司的名字叫双迪，他和珍奥是一家集团，好了"
            #"text": '\uFEFF' + "[content]\n北京的天气"
            #"text": '\uFEFF' + "[content]\n了解到您不太想继续这个话题，那我们换个方向聊聊吧，作为大健康行业的专业人士您觉得现在消费者在选择保健品时最常遇到的误区是什么？可以分析一些实用的选购建议吗？"
            ##"text": '\uFEFF' + "[content]\nnice to meet you."
        },
        "data": {
            "status": 0,
