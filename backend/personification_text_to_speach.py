    ...
    try:
        ...
        if("payload" in message):
            ...
            if code != 0:
                ...
                with open(ws.path, 'ab') as f:    # 这里文件后缀名，需要和业务参数audio.encoding 对应
                    f.write(audio)
...
if __name__ == "__main__":
    appid = '5f30a0b3'
    apisecret = 'MGYyMzJlYmYzZWVmMjIxZWE4ZThhNzA4'
    apikey = 'd4070941076c1e019907487878384f6c'
    file_path = './uploads/tts/'
    text_to_speech('测试的音频',appid,apisecret,apikey,file_path)
